...
export const updateStorefrontHeroSlideBodySchema = z.object({
  ...
  primaryAction: z.string().min(1, "Texto do botão principal é obrigatório.").optional(),
  secondaryAction: z.string().min(1, "Texto do botão secundário é obrigatório.").optional(),
